...
if not CWA_API_KEY:
    ...
    try:
        ...
        # 2. 處理嘉義未來一週預報 (F-D0047-059) -> 轉化為官網矩陣排版
        ...
        try:
            ...
            if cy_wx:
                # 建立多因子字典
                matrix_data = {}
                for i, t in enumerate(cy_wx['time'][:12]): # 拿前 6 天 (12個時段)
        ...
        # 2. 處理桃園未來一週預報 (F-D0047-007) -> 轉化為官網矩陣排版
